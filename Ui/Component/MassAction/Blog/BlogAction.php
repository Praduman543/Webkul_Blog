 ...
 */
namespace Webkul\Blog\Ui\Component\MassAction\Blog;

use Magento\Framework\UrlInterface;
use Zend\Stdlib\JsonSerializable;
use Webkul\Blog\Model\ResourceModel\Blog\CollectionFactory;

/**
 * Class BlogAction
 * Blog action (approve,rejected, delete)
 */
class BlogAction implements JsonSerializable
{
    /**
     * @var array
     */
    ...
    {
        $userId =  $this->_getRequest->getParam('user_id');
            ...
            foreach ($options as $optionCode) {
                ...
                if ($this->_urlPath && $this->_paramName) {
                    $this->_options[$optionCode['value']]['url'] = $this->_urlBuilder->getUrl(
                        $this->_urlPath,
                        [$this->_paramName => $optionCode['value'],'user_id'=>$userId]
                    );
                }
